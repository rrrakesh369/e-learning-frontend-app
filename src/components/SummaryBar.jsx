    ...
    <div>
      ...
      <div className="stats shadow w-full rounded-none bg-base-200">
        <div className="stat">
          ...
          <div className="stat-value text-error">{stats.unread}</div>
        </div>
        ...
        <div className="stat">
          <div className="stat-title">SYSTEM_ALERT</div>

          <div className="stat-value">{stats.byType.SYSTEM_ALERT || 0}</div>
        </div>

        <div className="stat">
          <div className="stat-title">COURSE_ENROLLED</div>

          <div className="stat-value">{stats.byType.COURSE_ENROLLED || 0}</div>
        </div>

        <div className="stat">
          <div className="stat-title">CERTIFICATE_ISSUED</div>
        ...
        <div className="stat">
          <div className="stat-title">ASSIGNMENT_DUE</div>

          <div className="stat-value">{stats.byType.ASSIGNMENT_DUE || 0}</div>
        </div>
      </div>

      <div className="flex justify-between my-4">
        <button className="btn btn-soft btn-info" onClick={handleRefresh}>
          Refresh
        </button>
        <button
