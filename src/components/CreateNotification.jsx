...
const CreateNotification = ({ fetchStats, fetchNotifications, closeForm }) => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen">
      <form
        ...
        className="card bg-base-100 p-6 shadow w-full max-w-md"
      >
        <input
          type="text"
          name="userId"
        ...
        <button
          type="submit"
          className="btn btn-soft btn-info w-32 mx-auto mt-3"
        >
          Submit
        </button>
      </form>
